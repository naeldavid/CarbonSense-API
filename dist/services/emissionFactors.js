...
class EmissionFactorsService {
     ...
     */
    static getFactorById(id) {
        return emissionFactors[id];
    }
    /**
     * Get all emission factors
     */
    static getAllFactors() {
        return Object.values(emissionFactors);
    }
    /**
     * Get factors by category
     */
    static getFactorsByCategory(category) {
        return Object.values(emissionFactors).filter((factor) => factor.category === category);
    }
    /**
     * Search factors by keyword
     */
    static searchFactors(keyword) {
        const lowerKeyword = keyword.toLowerCase();
        return Object.values(emissionFactors).filter((factor) => factor.activityType.toLowerCase().includes(lowerKeyword) ||
